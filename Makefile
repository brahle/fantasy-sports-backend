...
release:          ## Create a new tag for release.
	...
	@echo "$${TAG}" > fantasy_sports_backend/VERSION
	@$(ENV_PREFIX)gitchangelog > HISTORY.md
	@git add fantasy_sports_backend/VERSION HISTORY.md
...
switch-to-poetry: ## Switch to poetry package manager.
	...
	@echo "fantasy_sports_backend = 'fantasy_sports_backend.__main__:main'" >> pyproject.toml
	...
	@echo "Please run 'poetry shell' or 'poetry run fantasy_sports_backend'"
